...
ActiveRecord::Schema.define(version: 2020_05_02_232328) do
  ...
  create_table "playlist_containers", force: :cascade do |t|
    ...
    t.index ["time_period_id"], name: "index_playlist_containers_on_time_period_id"
  end
  ...
  create_table "song_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["hash_tag_id"], name: "index_song_tags_on_hash_tag_id"
  ...
  add_foreign_key "playlist_containers", "songs"
